...
PATH = "/app/project_7_oc_dashboard/" # os.getcwd()+'/' # change for online app or local
...
st.set_page_config(page_title="Lerys' Dashboard", # Must be 1st st statement
                   page_icon="☮",
...
if rad == '🏠 Home': # with this we choose which container to display on the screen
    with header:
        ...
        st.header("**Lérys Granado, OpenClassrooms Data Scientist, Project 7, Sept. 2021**")
